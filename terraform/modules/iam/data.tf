locals {
  ...
  service_account_default_name = "shortlet-automation-${substr(var.cluster_name, 0, min(15, length(var.cluster_name)))}-${random_string.cluster_service_account_suffix.result}"
